...
function loopThroughElements() {
  Array.prototype.forEach.call(showRow, function (element) {
    if (
      isInView(element) &&
      element.classList.contains('dont-show') &&
      element.classList.contains('show-content') == false
    ) {
  ...
  Array.prototype.forEach.call(showColumn, function (element) {
    if (
      isInView(element) &&
      element.classList.contains('dont-show-side') &&
      element.classList.contains('show-content-side') == false
    ) {
    ...
    if (
      isInView(element) &&
      element.classList.contains('dont-show') &&
      element.classList.contains('show-content-img') == false
    ) {
...
Array.prototype.forEach.call(showListBlank, function(element){
    ...
    Array.prototype.forEach.call(listPullDown, function (element) {
      if (
        isInView(element) &&
        element.classList.contains('show-list-item') == false
      ) {
        element.parentNode.classList.add('show-list-item')
      }
    })
    ...
    Array.prototype.forEach.call(elementsToShow, function (element) {
      if (
        isInView(element) &&
        element.classList.contains('is-visible') == false
      ) {
